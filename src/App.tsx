		...
		<>
			<main className='min-h-dvh px-4 pt-16.25 pb-15.75 md:flex md:items-center md:justify-center md:pt-33.25 md:pb-48.75'>
				<section className='flex flex-col gap-4 md:w-135'>
					...
					<div className='p-4 bg-grey-800 flex items-center justify-between md:py-4 md:px-8'>
						<span className='text-preset2 text-grey-700 md:text-preset1'>P4$5W0rD!</span>
					...
					<form className='p-4 bg-grey-800 flex flex-col gap-8 md:py-6 md:px-8'>
						<div className='flex flex-col gap-2 md:gap-4'>
							<div className='flex justify-between items-center'>
								<p className='text-preset4 text-white md:text-preset3'>Character Length</p>
								<span className='text-preset2 text-green-200 md:text-preset1'>0</span>
							</div>
